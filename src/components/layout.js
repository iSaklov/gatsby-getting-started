  ...
  return (
    <div className={container}>
      ...
      <footer className={footer}>
        ...
        <p>
          Copying and using the material without giving credit is only
          encouraged in parallel universes where coffee doesn't burn your
          tongue, and penguins know how to dance the lambada.
        </p>
        <p>
          Any attempt to steal content will result in an immediate universe
          reboot. For reality coordination, please contact the website creator.
          🤖
        </p>
      </footer>
    </div>
